...
var author$project$Main$calculate = F3(
	function (result, operation, number) {
		var floatNumber = function () {
			var _n1 = elm$core$String$toFloat(number);
			if (_n1.$ === 'Just') {
				var _float = _n1.a;
				return _float;
			} else {
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		var floatNumber = function (num) {
			var _n11 = elm$core$String$toFloat(num);
			if (_n11.$ === 'Just') {
				var _float = _n11.a;
				return _float;
			} else {
		...
		switch (msg.$) {
			...
			case 'ChangeSign':
				return _Utils_update(
					...
					{
						activeOperation: author$project$Main$NoOp,
						number: elm$core$String$fromFloat(
							(-1) * floatNumber(number)),
						result: (-1) * result,
						screen: elm$core$String$fromFloat(
							(-1) * floatNumber(screen))
					});
			case 'Persent':
				return _Utils_update(
					model,
			...
			default:
				return _Utils_update(
					model,
					{activeOperation: author$project$Main$NoOp, number: '', operation: author$project$Main$NoOp, result: 0, screen: '0'});
		}
	});
var author$project$Main$Addition = {$: 'Addition'};
var author$project$Main$ChangeSign = {$: 'ChangeSign'};
var author$project$Main$Division = {$: 'Division'};
var author$project$Main$EnterDigit = function (a) {
	return {$: 'EnterDigit', a: a};
};
var author$project$Main$EnterOperation = function (a) {
	return {$: 'EnterOperation', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('other'),
								elm$html$Html$Events$onClick(author$project$Main$Reset)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('AC')
							])),
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('other'),
								elm$html$Html$Events$onClick(author$project$Main$ChangeSign)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('+/-')
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('other'),
								elm$html$Html$Events$onClick(author$project$Main$Persent)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('%')
							...
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2(
										'active-operation',
										_Utils_eq(model.activeOperation, author$project$Main$Division))
									])),
								elm$html$Html$Attributes$class('operations'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterOperation(author$project$Main$Division))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('/')
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('7'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('8'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('9'))
							]),
						_List_fromArray(
							[
							...
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2(
										'active-operation',
										_Utils_eq(model.activeOperation, author$project$Main$Multiplication))
									])),
								elm$html$Html$Attributes$class('operations'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterOperation(author$project$Main$Multiplication))
							]),
						_List_fromArray(
							[
					...
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('4'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('5'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('6'))
							]),
						_List_fromArray(
							[
							...
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2(
										'active-operation',
										_Utils_eq(model.activeOperation, author$project$Main$Substraction))
									])),
								elm$html$Html$Attributes$class('operations'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterOperation(author$project$Main$Substraction))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('-')
					...
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('1'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('2'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('3'))
							]),
						_List_fromArray(
							[
							...
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2(
										'active-operation',
										_Utils_eq(model.activeOperation, author$project$Main$Addition))
									])),
								elm$html$Html$Attributes$class('operations'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterOperation(author$project$Main$Addition))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers big-button'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('0'))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('numbers'),
								elm$html$Html$Events$onClick(
								author$project$Main$EnterDigit('.'))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('.')
